...
const HomeMain = () => {
  return (
    // <main className=" bg-[url(/tractor.png)] h-[636px] bg-cover backdrop-brightness-100 text-white py-4 px-1 md:px-[90px] xl:px-[100px]">
    ...
    //     <h1 className="w-full text-[35px] md:w-[80%] md:text-[48px] xl:w-[65%] xl:text-[70px] font-bold">
