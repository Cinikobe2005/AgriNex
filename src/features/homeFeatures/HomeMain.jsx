...
const HomeMain = () => {
  return (
    <main className="flex flex-col justify-center md:items-start items-center md:text-left text-center gap-5 h-screen bg-[url(/tractor.png)] bg-cover backdrop-brightness-100 text-white py-4 px-6 md:px-10 lg:px-20">
